...
for seed in 42 7 1701; do
  for cfg in \
    "$PROJECT_DIR/configs/deberta-v3-large_window.yaml" \
    "$PROJECT_DIR/configs/deberta-v3-large_doc.yaml" \
    "$PROJECT_DIR/configs/deberta-v3-large_window_rag.yaml" \
    "$PROJECT_DIR/configs/deberta-v3-large_doc_rag.yaml" \
    "$PROJECT_DIR/configs/deberta-v3-large_sentence.yaml" \
    "$PROJECT_DIR/configs/deberta-v3-large_sentence_rag.yaml"; do

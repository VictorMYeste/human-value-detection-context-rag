...
RUN_SCRIPT="$PROJECT_DIR/scripts/run_qwen.py"
...
infer_artifact_prefix() {
  ...
  cfg_tag="${base_name#qwen2.5-72b-instruct_}"
  ...
  printf 'qwen_%s_%s_%s' "$context_type" "$run_tag" "$MODEL_SLUG"
}

for cfg in \
  "$PROJECT_DIR/configs/qwen2.5-72b-instruct_sentence.yaml" \
  "$PROJECT_DIR/configs/qwen2.5-72b-instruct_sentence_rag.yaml" \
  "$PROJECT_DIR/configs/qwen2.5-72b-instruct_window.yaml" \
  "$PROJECT_DIR/configs/qwen2.5-72b-instruct_window_rag.yaml" \
  "$PROJECT_DIR/configs/qwen2.5-72b-instruct_doc.yaml" \
  "$PROJECT_DIR/configs/qwen2.5-72b-instruct_doc_rag.yaml"; do
